...
const NotesBlock = ({ 
  ...
  return (
    <div
      onClick={onClick}
      className={`cursor-pointer w-full bg-white border border-gray-100 border-l-4 ${selectedColor.border} rounded-r-xl rounded-l-sm p-5 shadow-sm hover:shadow-md transition-shadow duration-200 flex flex-col justify-between h-[260px] relative`}
    >
